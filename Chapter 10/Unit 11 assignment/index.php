<DOCTYPE html>
    <html lang="en">
        <head>
            <!-- include the code for the head and other metadata -->
            <span><?php include_once('src\head.php'); ?></span>
        </head>
        <body>
            <!-- including the code for the header / navbar -->
            <span><?php include_once('header.php'); ?> </span>
            ...
            <main>sd
                <div class="row" style="padding-top:1em">
                    ...
                    <div class="column">
                        <h2 style="margin-top:35px"> Welcome to Hartrum's Pet Shop, where passion meets paws! As a cherished, family-owned establishment since 1985, we've been dedicated to bringing joy to the lives of both pets and their owners. Our expansive range includes a delightful selection of pets, from playful puppies and cuddly kittens to exotic birds and small mammals, all looking for their forever homes. <br><br>
                            ...
                            Explore our online catalog for premium pet foods, toys, and accessories that will keep your pets happy and healthy. At Hartrum's Pet Shop, we believe every pet deserves a loving home, and we're here to support you every step of the way. Join our pet-loving family today!</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="column">
                        ...
                        <h2 class="responsiveTXT">Indulge your furry friend with our exquisite range of high-end pet food options at Hartrum's Pet Shop. <h2>
                    </div>
                    <div class="column">
                        <figure>
                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        <h2 class="responsiveTXT">In times of need, trust our skilled veterinarians for surgeries and emergency medical care, offering compassionate support and expertise to ensure your pet receives the best treatment possible. <h2>
                    </div>
                </div>
                <div class="row">
                    <div class="column">
                    ...
                    <div class="column">
                        ...
                        <h2 class="responsiveTXT">And when it comes to building a strong and loving bond with your pet, our experienced trainers are here to guide you through every step, creating a harmonious connection that lasts a lifetime. <h2>
                    </div>
                </div>
            </main>

            <!-- inluding the footer -->
            <span><?php include_once('footer.html'); ?></span>
        </body>
